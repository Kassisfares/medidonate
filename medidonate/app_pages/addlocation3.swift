...
struct addlocation3: View {
    ...
    @State var showview7: Bool = false
    @State var showview6: Bool = false
    var body: some View {
        NavigationView{
            ScrollView{
                    ...
                    HStack{
                        Group{
                            ...
                            Text("Create post")
                                ...
                                .foregroundColor(.black)
                                .offset(x: -5)
                            NavigationLink (destination: sharepostinhome().navigationBarBackButtonHidden(), label:{
                                ZStack{
                                    Rectangle()
                                        .cornerRadius(12)
